...
describe('UserRepository', () => {
  ...
  describe('signUp', () => {
    ...
    it('successful signs up the user', async () => {
    ...
    it('throws a conflict expection as user already exists', async () => {
    ...
    it('throws a conflict expection as user already exists with unhandled error code', async () => {
